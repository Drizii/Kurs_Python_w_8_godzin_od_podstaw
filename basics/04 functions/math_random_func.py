...
print(round(12.75438589, 3))  # 12.754
print(round(12.75438589, 2))  # 12.75
print(round(12.75438589, 1))  # 12.7
...
print(random.choice(("Ola", "Ala", "Adam")))
